...
await repondre(`SCENE-MD SPEED:*_${flashspeed}_* MS`);
...
zokou({ nomCom: 'uptime',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`Uptime of SCENE-MD : ${runtime(process.uptime())}`) 
...
zokou({ nomCom: 'runtime',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*SCENE-MD IS CURRENTLY ACTIVE*\n\nSCENE-MD has been running endlessly for  ${runtime(process.uptime())}`) 
